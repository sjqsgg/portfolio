...
export const hotspotNodes = { monitor: 'HOTSPOT_monitor', camera: 'Camera_Mirrorless', lamp: 'Lamp_Shade', cv: 'HOTSPOT_cv', badge: 'HOTSPOT_badge', guestbook: 'HOTSPOT_guestbook', board: 'Felt_Board_Assembly', film: 'Camera_Film', lens: 'Lens_Standalone_01', mug: 'Ceramic_Mug_Base', audio: 'Central_Audio_Module' }
